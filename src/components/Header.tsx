...
import { HardHat, RefreshCw, ExternalLink, Database, Globe, Download, Sparkles } from 'lucide-react';
    ...
    <header className="bg-slate-900 border-b border-slate-800 text-slate-100 sticky top-0 z-30 shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          {onOpenAiInsights && (
            <button
              id="header-btn-ai-insights"
              onClick={onOpenAiInsights}
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-md bg-gradient-to-r from-amber-600/30 to-amber-500/20 hover:from-amber-600/40 hover:to-amber-500/30 text-amber-300 border border-amber-500/40 transition cursor-pointer shadow-sm"
